		...
		<ul class="side-nav-menu scrollable">
			...
			<li class="nav-item dropdown">
				<a class="dropdown-toggle" href="<?php echo base_url() ?>admin">
					<span class="icon-holder">
						<i style="font-size: 28px;" class="anticon anticon-rocket fa-lg"></i>
					</span>
			...
			<li class="nav-item dropdown">
				<a class="dropdown-toggle" href="javascript:void(0);">
					<span class="icon-holder">
						<i style="font-size: 28px;"  class="anticon anticon-shopping fa-lg"></i>
					</span>
				...
				<ul class="dropdown-menu">
					<li>
						<a href="<?php echo base_url() ?>admin/products">Administrar Productos</a>
					</li>

					<li>
						<a href="<?php echo base_url() ?>admin/categories">Administrar Categorias</a>
					</li>
				</ul>
			</li>
			...
			<li class="nav-item dropdown">
				<a class="dropdown-toggle" href="javascript:void(0);">
                                <span class="icon-holder">
                                    <i style="font-size: 28px;" class="fa anticon anticon-usergroup-add"></i>
                                </span>
			...
			<li class="nav-item dropdown">
				<a class="dropdown-toggle" href="javascript:void(0);">
                                <span class="icon-holder">
                                    <i style="font-size: 28px;" class="anticon anticon-message"></i>
                                </span>
					<span class="title">Mis Mensajes</span>
					<span class="arrow">
                                    <i class="arrow-icon"></i>
                                </span>
				</a>

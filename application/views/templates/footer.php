...
<footer class="footer">
	<div class="footer-content">
		<p class="m-b-0">Copyright © <?php echo date("Y") ?> Echo Software Solutions. All rights reserved.</p>
		<span>
	...
	$(document).ready(function() {
		...
		$('#data-table').DataTable({
			...
			buttons: [
				...
				{extend:'csvHtml5', className: 'btn btn-success',title:'Report <?php echo date("m-d-Y"); ?>'},
				{extend:'pdfHtml5', className: 'btn btn-danger',title:'Report <?php echo date("m-d-Y"); ?>'},
			]
		});
	});

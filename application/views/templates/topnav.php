		...
		<div class="header">
			<div class="logo logo-dark text-center">
				<a href="<?php echo base_url() ?>">
					<span class="text-center text-dark font-weight-bolder"></span>
					<img class="text-center" src="<?php echo base_url() ?>assets/front/img/logonb.png" alt="Logo" width="200" height="50">
					<img style="margin-left: 1px;" class="logo-fold text-center" src="<?php echo base_url() ?>assets/front/img/logonb.png" alt="Logo"  width="50" height="50">
				</a>
			</div>
			<div class="logo logo-white">
				<a href="<?php echo base_url() ?>">
					<img src="<?php echo base_url() ?>assets/front/img/logonb.png" alt="Logo" width="50" height="20">
					<img class="logo-fold text-center" src="<?php echo base_url() ?>assets/front/img/logonb.png" alt="Logo" width="50" height="50">
				</a>
			</div>
			<div class="nav-wrap">
				<ul class="nav-left">
